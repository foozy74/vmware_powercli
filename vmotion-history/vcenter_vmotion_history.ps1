...
function clustername ()
 ...
 [console]::ForegroundColor = "yellow"
 [console]::BackgroundColor= "black"
 [string]$global:sourceclt=Read-Host "Please enter Clustername "
 [console]::ResetColor()
 }
...
vCenter_Connect
clustername
Get-Cluster -Name $global:sourceclt | Get-vMotionHistory -Hours 24 -Recurse:$true | Export-Csv d:\temp\vmotion-$global:sourceVI.csv -NoTypeINformation -UseCulture
